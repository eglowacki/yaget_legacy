...
// 26/05/02, M : rewriting                                                                                            //
//--------------------------------------------------------------------------------------------------------------------//

#ifndef   _MYTHOS_VECTMAT_INL_
#define   _MYTHOS_VECTMAT_INL_

//----------------------------------------------- INCLUDES -----------------------------------------------------------//

#include  <math.h>
#include  <memory.h>
#include  "Debugging/MyAssert.h"
...
inline CVect2D::CVect2D(const CVect3D& v3V,const ui uiDropAxis)                 // cast v3 to v2 (drop an axis)
  ...
  switch (uiDropAxis)
    { 
    case _X_ : x = v3V.y; y = v3V.z; break;
    case _Y_ : x = v3V.x; y = v3V.z; break;
...
inline CVect2D& CVect2D::operator /= (const float fK)                           // division by a constant
  { _ASSERT_(fK != 0.f,"division by zero !");
    float fKinv  = 1.f/fK;
    x *= fKinv; y *= fKinv; return *this; }

inline CVect2D& CVect2D::operator /= (const CVect2D& v2V)                       // term by term /
  { _ASSERT_(v2V.x != 0.f,"division by zero !");
    _ASSERT_(v2V.y != 0.f,"division by zero !");
    x /= v2V.x; y /= v2V.y; return *this; }

inline float&   CVect2D::operator [] (const ui uiIndex)                         // indexing
  { _ASSERT_(uiIndex <= _Y_,"invalid index");
    return V[uiIndex]; }
...
inline CVect2D Div     (const CVect2D& v2V1,const CVect2D& v2V2)                // term by term /
  { _ASSERT_(v2V2.x != 0.f,"division by zero !");
    _ASSERT_(v2V2.y != 0.f,"division by zero !");
    return CVect2D(v2V1.x/v2V2.x,v2V1.y/v2V2.y); }
...
inline CVect3D::CVect3D(const CVect4D& v4V,const ui uiDropAxis)                 // cast v4 to v3 (drop an axis)
  ...
  switch (uiDropAxis)
    { 
    case _X_ : x = v4V.y; y = v4V.z; z = v4V.w; break;
    case _Y_ : x = v4V.x; y = v4V.z; z = v4V.w; break;
    case _Z_ : x = v4V.x; y = v4V.y; z = v4V.w; break;
...
inline CVect3D& CVect3D::operator /= (const CVect3D& v3V)                       // term by term /
  { _ASSERT_(v3V.x != 0.f,"division by zero !");
    _ASSERT_(v3V.y != 0.f,"division by zero !");
    _ASSERT_(v3V.z != 0.f,"division by zero !");
    x /= v3V.x; y /= v3V.y; z /= v3V.z; return *this; }

inline float&   CVect3D::operator [] (const ui uiIndex)                         // indexing
  {
  _ASSERT_(uiIndex <= _Z_,"invalid index");
  return V[uiIndex]; 
  }
...
inline CVect3D Div     (const CVect3D& v3V1,const CVect3D& v3V2)                // term by term /
  { _ASSERT_(v3V2.x != 0.f,"division by zero !");
    _ASSERT_(v3V2.y != 0.f,"division by zero !");
    _ASSERT_(v3V2.z != 0.f,"division by zero !");
    return CVect3D(v3V1.x/v3V2.x,v3V1.y/v3V2.y,v3V1.z/v3V2.z); }
...
inline CVect4D& CVect4D::operator /= (const CVect4D& v4V)                       // term by term /
  { _ASSERT_(v4V.x != 0.f,"division by zero !");
    _ASSERT_(v4V.y != 0.f,"division by zero !");
    _ASSERT_(v4V.z != 0.f,"division by zero !");
    _ASSERT_(v4V.w != 0.f,"division by zero !");
    x /= v4V.x; y /= v4V.y; z /= v4V.z; w /= v4V.w; return *this; }

inline float&   CVect4D::operator [] (const ui uiIndex)                         // indexing
  {
  _ASSERT_(uiIndex <= _W_,"invalid index");
  return V[uiIndex]; 
  }
...
inline CVect4D Div     (const CVect4D& v4V1,const CVect4D& v4V2)                // term by term /
  { _ASSERT_(v4V2.x != 0.f,"division by zero !");
    _ASSERT_(v4V2.y != 0.f,"division by zero !");
    _ASSERT_(v4V2.z != 0.f,"division by zero !");
    _ASSERT_(v4V2.w != 0.f,"division by zero !");
    return CVect4D(v4V1.x/v4V2.x,v4V1.y/v4V2.y,v4V1.z/v4V2.z,v4V1.w/v4V2.w); }
