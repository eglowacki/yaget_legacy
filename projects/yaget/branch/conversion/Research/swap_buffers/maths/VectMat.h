...
#ifndef   _MYTHOS_VECTMAT_H_
#define   _MYTHOS_VECTMAT_H_
#pragma    once

//----------------------------------------------- INCLUDES -----------------------------------------------------------//

#include  <strstrea.h>                                      // ostrstream
#include  "Global/BasicTypes.h"

//----------------------------------------------- DEFINES ------------------------------------------------------------//

enum      { _X_,_Y_,_Z_,_W_ };                              // 4D axis
enum      { _R_,_G_,_B_,_A_ };                              // 4D color
enum      { _U_,_V_ };                                      // 2D tex coord
enum      { _S_,_T_,_P_,_Q_ };                              // 4D tex coord

enum      { _XN_,_UP_,_DIR_,_POS_ };                        // matrix columns meanings

#define   _PI_                          3.141592654f
#define   _EPS_NORMALIZE_               0.001f

//----------------------------------------------- MACROS -------------------------------------------------------------//

#define   _RAD2DEG_(fAngleRad)          (fAngleRad*180.f/_PI_)
#define   _DEG2RAD_(fAngleDeg)          (fAngleDeg*_PI_/180.f)
